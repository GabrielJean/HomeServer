...
variable "keyboard_layout" { default = "en-us" }
variable "migrate" { default = false }
variable "on_boot" { default = true }
variable "reboot" { default = false }
variable "reboot_after_update" { default = true }
variable "stop_on_destroy" { default = false }
variable "timeout_clone" { default = 1800 }
variable "timeout_create" { default = 1800 }
variable "timeout_migrate" { default = 1800 }
variable "timeout_reboot" { default = 1800 }
variable "timeout_shutdown_vm" { default = 1800 }
variable "timeout_start_vm" { default = 1800 }
variable "timeout_stop_vm" { default = 300 }

variable "agent_enabled" { default = true }
variable "agent_timeout" { default = "15m" }
variable "agent_trim" { default = false }
variable "agent_type" { default = "virtio" }
